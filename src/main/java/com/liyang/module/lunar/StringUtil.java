...
public class StringUtil {
    ...
    public static String removeOrders(String sql) {
        ...
        Pattern p = Pattern.compile("order\\s*by [\\w|\\W|\\s|\\S]*", Pattern.CASE_INSENSITIVE); //Pattern.CASE_INSENSITIVE
    ...
    public static String substringAfterLast(String str, String separator) {
        if (str == null || separator == null) return EMPTY;
        int pos = str.lastIndexOf(separator);
    ...
    public static String replace(String text, String repl, String with, int max) {
        if (text == null || repl == null || with == null || max == 0) return text;
        int start = 0;
    ...
    public static String checkSql(String source) {
        ...
        for (int i = 0; i < source.length(); i++) {
            ...
            if (c == '<')
                ...
                result.append("&gt;");
            else if (c == SINGLE_QUOTE_TAG)
                result.append(StringUtil.toUTFString("\'"));
            else if (c == DOUBLE_QUOTE_TAG)
                result.append(StringUtil.toUTFString("\""));
            else result.append(c);
        }
        return StringUtil.replaceIgnoreCase(result.toString(), " or ", "");
    }
    ...
    */
    ...
    public static String combineStringArray
        ...
        if (delim == null) delim = "";
        StringBuilder result = new StringBuilder();
        for (String aArray : array) result.append(aArray).append(delim);
    ...
    */
    ...
    public static boolean isNULL(String value) {
        return value == null || value.equals("") || value.equals("null") || value.length() < 1;
    }
    ...
    public static Map<String, String> toMap
            (String
                    ...
                    fen1, String
                    fen2) {
        if (str == null) return new HashMap<String, String>(0);
        if (isNULL(fen1)) {
            fen1 = ";";
        }
        if (isNULL(fen2)) fen2 = ":";
        ...
        for (String aSlist : slist) {
            ...
            if (aSlist.indexOf(fen2) != -1) {
                key = StringUtil.substringAfter(aSlist, fen2);
    ...
    public static String getElementName(String element) {
        if (StringUtil.isNULL(element)) return "";
    ...
    static public String substring(String str, int ibein, int iend) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (result > ibein && result <= iend) {
                resultString.append(str.substring(i, i + 1));
            }
        }
    ...
    public static boolean toBoolean(String str) {
        return !isNULL(str) && (str.equalsIgnoreCase("TRUE") || str.equalsIgnoreCase("yes") || str.equalsIgnoreCase("y") || str.equalsIgnoreCase("T") || str.equalsIgnoreCase("是") || str.equalsIgnoreCase("ok")) || (isNumber(str)&&toInt(str)>0);
    }
    ...
    public static Date toDate(String date) throws ParseException {
        ...
        if (date.length() == DateUtil.FULL_ST_FORMAT.length() && StringUtil.countMatches(date, "-") == 2 && StringUtil.countMatches(date, ":") == 2) {
            fomat = DateUtil.FULL_ST_FORMAT;
        } else if (date.length()==DateUtil.CURRENCY_ST_FORMAT.length() && StringUtil.countMatches(date, "-") == 2 && StringUtil.countMatches(date, ":") == 1) {
    ...
    public static boolean checkMail(String str) {
        return !(str == null || str.length() < 2) && str.indexOf("@") != -1 && str.indexOf(".") != -1;
    }
     ...
     * @return String 修复切分
     */
    public static String fixCompart(String compart, String fen) {
        if (compart == null) return "";
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < compart.length(); i++) {
            if ('/' == compart.charAt(i) || ' ' == compart.charAt(i) || ';' == compart.charAt(i))
                sb.append(fen);
            else
                sb.append(compart.charAt(i));
        }
        return sb.toString();
    }
     ...
     * @param separator 分割
     * @param order     排序方式
     * @return public static Set<OneWord> getWordCount
    (String  str, String
    separator, Comparator<OneWord> order)
    {
    WordStatCount wst = new WordStatCount();
    return wst.getWordCount(str, separator, order);
    }

    public static Set<OneWord> getWordCount
    (String
    str, String
    separator)
    {
    WordStatCount wst = new WordStatCount();
    return wst.getWordCount(str, separator);
    }
     */
}
