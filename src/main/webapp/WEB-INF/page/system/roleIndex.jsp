				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="${ctx }/role/add" class="btn btn-default btn-sm">
	...
	jQuery(document).ready(function() {    
	   ...
	   $('#datatable_ajax tbody').on( 'click', '.edit', function () {
	      ...
	      // console.info(jqTds[0].innerHTML);
	       window.location.href = "${ctx}/role/update?id="+jqTds[0].innerHTML;
	    } );
	   $('#datatable_ajax tbody').on( 'click', '.delete', function () {
		   ...
		   window.location.href = "${ctx}/role/delete?id="+jqTds[0].innerHTML;
