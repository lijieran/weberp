...
<link href="${ctxStatic}/metronic/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="${ctxStatic}/metronic/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->


<link rel="shortcut icon" href="${ctxStatic}/metronic/media/image/favicon.ico" />
<style type="text/css">
#datatable_ajax {
	font-size: 14px;
}
