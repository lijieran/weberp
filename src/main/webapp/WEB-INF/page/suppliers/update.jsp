			...
			<div class="page-content ">
				...
				<div class="portlet light bg-inverse form-fit">
					...
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<form action="${ctx }/suppliers/update" class="form-horizontal form-bordered" method="post" id="validateSubmitForm">
							<div class="form-body">
								<div class="form-group">
									<label class="control-label col-md-3">供应商编号<span class="required">* </span></label>
									<div class="col-md-9">
										<input type="text" placeholder="" class="form-control" name="id" value="${entity.id }" readonly/>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<mytag:myselect cssClass="form-control" type="country" name="country" value="${entity.country }"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" name="linkname" value="${entity.linkname }"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" name="fax" value="${entity.fax }"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" name="website" value="${entity.website }">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">公司规模</label>
									<div class="col-md-9">
										<mytag:select name="companysize" cssClass="form-control" metaType="companySize" value="${entity.companysize }"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" name="mainproduct" value="${entity.mainproduct }">
									</div>
								</div>
								<div class="form-group last">
									<label class="control-label col-md-3">供应商类型</label>
									<div class="col-md-9">
										<mytag:myselect cssClass="form-control" type="supplierType" name="typeid" value="${entity.typeid }"/>
									</div>
								</div>
								<div class="form-group last">
									<label class="control-label col-md-3">付款条款</label>
									<div class="col-md-9">
										<mytag:myselect cssClass="form-control" type="paymentterms" name="termscode" value="${entity.termscode }"/>
									</div>
								</div>
								<div class="form-group last">
									<label class="control-label col-md-3">供应商货币</label>
									<div class="col-md-9">
										<mytag:myselect cssClass="form-control" type="currencies" name="currabrev" value="${entity.currabrev }"/>
									</div>
								</div>
								<div class="form-group">
	...
	jQuery(document).ready(function() {    
	   ...
	   $("#validateSubmitForm").validate({
			rules: {
				name: {
					required: true,
					remote: {type: "Post",url:"${ctx}/suppliers/checkSupplierName",data:{source:"${entity.name}"}}
				},
