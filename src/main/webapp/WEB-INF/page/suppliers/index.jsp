				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="${ctx }/suppliers/add" class="btn btn-default btn-sm">
	...
	jQuery(document).ready(function() {    
	   ...
	   var table = $("#datatable_ajax").dataTable({
			...
			"bSort": false,
			 "pageLength": 10,
			"ajax": {
               "url": ctx+"/suppliers/list", // ajax source
           },
           "language": {
               ...
               "render": function(data, type, row) {
            	   var link = "<a href='${ctx}/supplier/info?id="+row.id+"'>"+data+"</a>";
            	   //console.info(link);
                   return link;
               },
               "targets": 1
	   ...
	   $('#datatable_ajax tbody').on( 'click', '.edit', function () {
	      ...
	      // console.info(jqTds[0].innerHTML);
	       window.location.href = "${ctx}/suppliers/update?id="+jqTds[0].innerHTML;
	    } );
	   $('#datatable_ajax tbody').on( 'click', '.delete', function () {
		   ...
		   window.location.href = "${ctx}/suppliers/delete?id="+jqTds[0].innerHTML;
