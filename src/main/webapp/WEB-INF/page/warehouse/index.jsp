				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							...
							<div class="caption">
								<i class="fa fa-cogs"></i>仓库信息
							</div>
							<div class="actions">
								<a href="${ctx }/warehouse/add" class="btn btn-default btn-sm">
	...
	jQuery(document).ready(function() {    
	   ...
	   var table = $("#datatable_ajax").dataTable({
			...
			"bSort": false,
			 "pageLength": 10,
			"ajax": {
               "url": ctx+"/warehouse/list", // ajax source
           },
           "language": {
	   ...
	   $('#datatable_ajax tbody').on( 'click', '.edit', function () {
	      ...
	      // console.info(jqTds[0].innerHTML);
	       window.location.href = "${ctx}/warehouse/update?id="+jqTds[0].innerHTML;
	    } );
	   $('#datatable_ajax tbody').on( 'click', '.delete', function () {
		   ...
		   window.location.href = "${ctx}/warehouse/delete?id="+jqTds[0].innerHTML;
