				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="${ctx }/supplier/add" class="btn btn-default btn-sm">
	...
	jQuery(document).ready(function() {    
	   ...
	   var table = $("#datatable_ajax").dataTable({
			...
			"bSort": false,
			 "pageLength": 10,
			"ajax": {
               "url": ctx+"/supplier/list", // ajax source
           },
           "language": {
	   ...
	   $('#datatable_ajax tbody').on( 'click', '.edit', function () {
	      ...
	      // console.info(jqTds[0].innerHTML);
	       window.location.href = "${ctx}/supplier/update?id="+jqTds[0].innerHTML;
	    } );
	   $('#datatable_ajax tbody').on( 'click', '.delete', function () {
		   ...
		   window.location.href = "${ctx}/supplier/delete?id="+jqTds[0].innerHTML;
