	...
	<div class="page-content-wrapper">
		<div class="page-content ">
			...
			<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="${ctx }/supplier/update" class="form-horizontal" id="validateSubmitForm" method="post">
										    <input type="hidden" name="id" value="${entity.id }">
											<div class="form-body">
												<h3 class="form-section">供应商信息修改</h3>
												<div class="row">
													<div class="col-md-6">
										...
										* </span></label>
															<div class="col-md-9">
																<input type="text" class="form-control" name="companyName" readonly value="${entity.companyName }">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" name="companyPhone" value="${entity.companyPhone }">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<textarea rows="4" class="form-control" name="remark" >${entity.remark}</textarea>
															</div>
														</div>
													</div>
													<!--/span-->
